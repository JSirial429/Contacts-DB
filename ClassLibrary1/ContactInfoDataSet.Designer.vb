...
Partial Public Class ContactInfoDataSet
    ...
    Partial Public Class EmployeesDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddEmployeesRow(ByVal First_Name As String, ByVal Middle_Name As String, ByVal Last_Name As String, ByVal Employee_Number As Integer, ByVal Department As String, ByVal Telephone As String, ByVal Extension As String, ByVal Email_Address As String) As EmployeesRow
            Dim rowEmployeesRow As EmployeesRow = CType(Me.NewRow,EmployeesRow)
            Dim columnValuesArray() As Object = New Object() {First_Name, Middle_Name, Last_Name, Employee_Number, Department, Telephone, Extension, Email_Address}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Function FindByEmployee_Number(ByVal Employee_Number As Integer) As EmployeesRow
            Return CType(Me.Rows.Find(New Object() {Employee_Number}),EmployeesRow)
        End Function
        ...
        Private Sub InitClass()
            ...
            Me.columnEmployee_Number = New Global.System.Data.DataColumn("Employee_Number", GetType(Integer), Nothing, Global.System.Data.MappingType.Element)
            ...
            Me.columnMiddle_Name.MaxLength = 2147483647
            ...
            Me.columnExtension.MaxLength = 2147483647
            Me.columnEmail_Address.MaxLength = 2147483647
        End Sub
    ...
    Partial Public Class EmployeesRow
        ...
        Public Property Employee_Number() As Integer
            Get
                Return CType(Me(Me.tableEmployees.Employee_NumberColumn),Integer)
            End Get
            Set
                Me(Me.tableEmployees.Employee_NumberColumn) = value
            End Set
        End Property
        ...
        Public Property Email_Address() As String
            Get
                ...
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'Email_Address' in table 'Employees' is DBNull.", e)
                End Try
            End Get
            Set
...
Namespace ContactInfoDataSetTableAdapters
    ...
    Partial Public Class EmployeesTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employees] WHERE (([Employee_Number] = @Original_Employee_Numb"& _ 
                "er))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_Employee_Number", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "Employee_Number", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            Me._adapter.InsertCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employees] ([First_Name], [Middle_Name], [Last_Name], [Employe"& _ 
                "e_Number], [Department], [Telephone], [Extension], [Email_Address]) VALUES (@Fir"& _ 
                "st_Name, @Middle_Name, @Last_Name, @Employee_Number, @Department, @Telephone, @E"& _ 
                "xtension, @Email_Address);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT First_Name, Middle_Name, Last_Name, Employee_"& _ 
                "Number, Department, Telephone, Extension, Email_Address FROM Employees WHERE (Em"& _ 
                "ployee_Number = @Employee_Number)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Employee_Number", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "Employee_Number", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Employees] SET [First_Name] = @First_Name, [Middle_Name] = @Middle_"& _ 
                "Name, [Last_Name] = @Last_Name, [Employee_Number] = @Employee_Number, [Departmen"& _ 
                "t] = @Department, [Telephone] = @Telephone, [Extension] = @Extension, [Email_Add"& _ 
                "ress] = @Email_Address WHERE (([Employee_Number] = @Original_Employee_Number));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT First_Name, Middle_Name, Last_Name, Employee_Number, Department, Telepho"& _ 
                "ne, Extension, Email_Address FROM Employees WHERE (Employee_Number = @Employee_N"& _ 
                "umber)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Employee_Number", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "Employee_Number", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_Employee_Number", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "Employee_Number", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
        End Sub
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.ClassLibrary1.My.MySettings.Default.ContactInfoConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT First_Name, Middle_Name, Last_Name, Employee_Number, Department, Telephone"& _ 
                ", Extension, Email_Address FROM dbo.Employees"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "INSERT INTO [dbo].[Employees] ([First_Name], [Middle_Name], [Last_Name], [Employe"& _ 
                "e_Number], [Department], [Telephone], [Extension], [Email_Address]) VALUES (@Fir"& _ 
                "st_Name, @Middle_Name, @Last_Name, @Employee_Number, @Department, @Telephone, @E"& _ 
                "xtension, @Email_Address);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT First_Name, Middle_Name, Last_Name, Employee_"& _ 
                "Number, Department, Telephone, Extension, Email_Address FROM Employees WHERE (Em"& _ 
            ...
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@First_Name", Global.System.Data.SqlDbType.NVarChar, 2147483647, Global.System.Data.ParameterDirection.Input, 0, 0, "First_Name", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Middle_Name", Global.System.Data.SqlDbType.NVarChar, 2147483647, Global.System.Data.ParameterDirection.Input, 0, 0, "Middle_Name", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Last_Name", Global.System.Data.SqlDbType.NVarChar, 2147483647, Global.System.Data.ParameterDirection.Input, 0, 0, "Last_Name", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Employee_Number", Global.System.Data.SqlDbType.Int, 4, Global.System.Data.ParameterDirection.Input, 0, 0, "Employee_Number", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Department", Global.System.Data.SqlDbType.NVarChar, 2147483647, Global.System.Data.ParameterDirection.Input, 0, 0, "Department", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Telephone", Global.System.Data.SqlDbType.NVarChar, 2147483647, Global.System.Data.ParameterDirection.Input, 0, 0, "Telephone", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Extension", Global.System.Data.SqlDbType.NVarChar, 2147483647, Global.System.Data.ParameterDirection.Input, 0, 0, "Extension", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Email_Address", Global.System.Data.SqlDbType.NVarChar, 2147483647, Global.System.Data.ParameterDirection.Input, 0, 0, "Email_Address", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As ContactInfoDataSet.EmployeesDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As ContactInfoDataSet.EmployeesDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As ContactInfoDataSet.EmployeesDataTable = New ContactInfoDataSet.EmployeesDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As ContactInfoDataSet.EmployeesDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Employee_Number As Integer) As Integer
            Me.Adapter.DeleteCommand.Parameters(0).Value = CType(Original_Employee_Number,Integer)
        ...
        Public Overloads Overridable Function Insert(ByVal First_Name As String, ByVal Middle_Name As String, ByVal Last_Name As String, ByVal Employee_Number As Integer, ByVal Department As String, ByVal Telephone As String, ByVal Extension As String, ByVal Email_Address As String) As Integer
            ...
            End If
            Me.Adapter.InsertCommand.Parameters(3).Value = CType(Employee_Number,Integer)
        ...
        Public Overloads Overridable Function Update(ByVal First_Name As String, ByVal Middle_Name As String, ByVal Last_Name As String, ByVal Employee_Number As Integer, ByVal Department As String, ByVal Telephone As String, ByVal Extension As String, ByVal Email_Address As String, ByVal Original_Employee_Number As Integer) As Integer
            If (First_Name Is Nothing) Then
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(3).Value = CType(Employee_Number,Integer)
            If (Department Is Nothing) Then
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(8).Value = CType(Original_Employee_Number,Integer)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal First_Name As String, ByVal Middle_Name As String, ByVal Last_Name As String, ByVal Department As String, ByVal Telephone As String, ByVal Extension As String, ByVal Email_Address As String, ByVal Original_Employee_Number As Integer) As Integer
            Return Me.Update(First_Name, Middle_Name, Last_Name, Original_Employee_Number, Department, Telephone, Extension, Email_Address, Original_Employee_Number)
        End Function
        ...
        Public Overloads Overridable Function addContact(ByVal First_Name As String, ByVal Middle_Name As String, ByVal Last_Name As String, ByVal Employee_Number As Integer, ByVal Department As String, ByVal Telephone As String, ByVal Extension As String, ByVal Email_Address As String) As Integer
            ...
            Else
                command.Parameters(1).Value = CType(Middle_Name,String)
            End If
            If (Last_Name Is Nothing) Then
            ...
            End If
            command.Parameters(3).Value = CType(Employee_Number,Integer)
            If (Department Is Nothing) Then
            ...
            Else
                command.Parameters(6).Value = CType(Extension,String)
            End If
            If (Email_Address Is Nothing) Then
